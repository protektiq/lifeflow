...
export default function TaskFeedback({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      {error && (
        <span className="text-xs text-red-600 w-full" role="alert">
          {error}
        </span>
      )}
      <button
        ...
        className="rounded-md bg-green-600 px-2.5 sm:px-3 py-1.5 text-xs sm:text-sm font-medium text-white hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-1"
      ...
      <div className="relative">
        <button
          ...
          disabled={loading || disabled}
          className="rounded-md bg-yellow-600 px-2.5 sm:px-3 py-1.5 text-xs sm:text-sm font-medium text-white hover:bg-yellow-700 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-1"
